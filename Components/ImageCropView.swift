...
struct ImageCropView: View {
    ...
    func cropImage() {
        if let croppedImage = sourceImage?.fixedOrientation()?.crop(scaledRectWidth: scaledRectWidth, scaledRectHeight: scaledRectHeight, paddingTop: paddingTop, paddingLeft: paddingLeft, paddingBottom: paddingBottom, paddingRight: paddingRight) {
